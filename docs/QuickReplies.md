...
|    `blockId`   |     String     |         Id of the quick replies block.        |    Optional    |                                                             ``` "blockId": "fallback-block" ```                                                             |
...
|     `value`    |     String     |                                                            Value of your quick replies action.                                                           |    Optional    |          Any          |     ``` "value": "anyvaluehere" ```     |
### Example
